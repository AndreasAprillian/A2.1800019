	<body class="menubar-hoverable header-fixed ">
		...
		<div id="base">
			...
			<header>
			<h3><b>Kritik Dan Saran</b></h3><br>
			</header>
			</div>
									<div class="card-body">
									<?php echo $this->session->flashdata('delete_pesan') ?>
									<div class="card style-primary">
										<table class="table table-hover no-margin">
											...
											<tbody>
											<?php $i = 1; foreach($s as $j){ ?> 
												<tr>
													<td><?php echo $i ?></td>
													<td><?php echo $j->nama;?></td>
													<td><?php echo $j->email;?></td>
													<td><?php echo $j->subjek;?></td>
													<td>
													<a href="<?php echo site_url('admin/view_datapesan/'.$j->id_saran.'')?>"><button type="button" class="btn btn-default-bright btn-raised" data-toggle="tooltip" data-placement="top" title="" data-original-title="Lihat Data"><i class="md md-remove-red-eye"></i></button></a>
													<a href="<?php echo site_url('admin/do_deletepesan/'.$j->id_saran.'')?>"><button type="button" class="btn btn-default-bright btn-raised" data-toggle="tooltip" data-placement="top" title="" data-original-title="Hapus Data"><i class="md md-delete"></i></button></a>
													</td>
												</tr>
												<?php $i = $i+1; } ?>
											</tbody>
