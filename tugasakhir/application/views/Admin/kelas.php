	<body class="menubar-hoverable header-fixed ">
		...
		<div id="base">
			...
			<h3><b>Kelas</b></h3><br>
									...
									<?php echo $this->session->flashdata('update_kelas') ?>
									<?php echo $this->session->flashdata('add_kelas') ?>
									<div align="right">
										<a href="<?php echo site_url('admin/add_kelas')?>"><button class="btn btn-primary btn-raised"><i class="md md-add"></i>Tambah</button></a>
										</div>
										...
										<table class="table table-hover no-margin">
											...
											<?php $i = 1; foreach($k as $j){ ?> 
												<tr>
													...
													<td>
													<a href="<?php echo site_url('admin/edit_datakelas/'.$j->id.'')?>"><button type="button" class="btn btn-default-bright btn-raised" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Data"><i class="md md-edit"></i></button></a>	
													<a href="<?php echo site_url('admin/do_deletekelas/'.$j->id.'')?>"><button type="button" class="btn btn-default-bright btn-raised" data-toggle="tooltip" data-placement="top" title="" data-original-title="Hapus Data"><i class="md md-delete"></i></button></a>
													</td>
												</tr>
												<?php $i = $i+1; } ?>
											</tbody>
