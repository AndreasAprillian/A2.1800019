	<body class="menubar-hoverable header-fixed ">
		...
		<div id="base">
			...
			<header>
			<h3><b>Tambah Berita</b></h3><br>
			</header>
			</div><?php echo form_open_multipart('admin/do_addberita')?>
			<div class="card-body">
			<div class="col-md-11">
			<div class="form-group">
			...
			<div class="form-group control-width-normal">
				<div class="input-group date" id="demo-date">
					<div class="input-group-content">
						<input type="text" class="form-control" name="date" placeholder="Tanggal (Hari, tt BB TT)">					
					</div>
			...
			<div class="col-md-3">
			<div class="form-group">
				<input type="text" name="time" class="form-control time-mask" placeholder="Waktu (HH:mm:ss)">
			</div>
			</div>
			<div class="col-md-3">
			<div class="form-group">
