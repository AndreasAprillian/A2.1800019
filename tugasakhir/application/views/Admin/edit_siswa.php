	<body class="menubar-hoverable header-fixed ">
		...
		<div id="base">
			...
			<header>
			<h3><b>Edit Siswa</b></h3><br>
			</header>
			</div>
			<div class="card-body">
			<form role="form" method="POST" action="<?php echo site_url('admin/do_updatesiswa')?>">
			...
			<input type="radio" name="jk" value="Laki-laki" <?php if(($jk) == "Laki-laki"){echo'checked';} ?>><span>Laki-laki</span>
			</label>
			<label class="radio-inline radio-styled">
			<input type="radio" name="jk" value="Perempuan" <?php if(($jk) == "Perempuan"){echo'checked';} ?>><span>Perempuan</span>
			</label>
			</div>
			</div>
			</div>
