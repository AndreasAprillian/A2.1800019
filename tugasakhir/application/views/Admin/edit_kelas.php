	<body class="menubar-hoverable header-fixed ">
		...
		<div id="base">
			...
			<header>
			<h3><b>Edit Kelas</b></h3><br>
			</header>
			</div>
			<div class="card-body">
			<form role="form" method="POST" action="<?php echo site_url('admin/do_updatekelas')?>">
			<input type="hidden" name="id" class="form-control" value="<?php echo $id; ?>">
			<div class="col-md-4">
			<div class="form-group">
			<input type="text" name="tingkat" class="form-control" value="<?php echo $tingkat; ?>">
			</div>
			</div>
			<div class="col-md-3">
			<div class="form-group">
